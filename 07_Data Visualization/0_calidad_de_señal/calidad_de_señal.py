...
# Helper functions#
###################
#Filters debbug (uncomment to go debugging the app)
...
def get_data(signal = "hsa12_loopout_esrsprtrdactrod_C1075052645",
    ...
    Returns
    -------
    data : Arroja una sola señal por segundo con la siguientes columnas.
           Time | gropings | grado_acero | value
    """
    extract_month_azure.azure_data_extraction(day_gregorate = day_gregorate,
                                              days = days)
...
def update_table_signal_statistics(signal,
                                   day_gregorate,
                                   grado_acero):
    """Actualiza los datos de la tabla estadística descriptiva."""
    data = get_data(signal = signal,
                    day_gregorate = day_gregorate,
                    grado_acero = grado_acero)
